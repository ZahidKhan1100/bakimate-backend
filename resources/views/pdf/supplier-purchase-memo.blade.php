...
<head>
    <meta charset="utf-8">
    <title>Purchase memo — {{ $supplier->name }}</title>
...
<body>
                ...
                <table class="meta-table" style="margin-top:0;">
                    <tr>
                        <td colspan="2" style="font-size:15px;font-weight:bold;text-transform:uppercase;text-align:right;padding-bottom:4px;">
                            PURCHASE / PAYABLE MEMO
                        </td>
                    </tr>
                    <tr>
                        <td class="meta-label r">DOCUMENT NO.&nbsp;&nbsp;</td>
                        <td class="meta-val"><strong>{{ $memoNo }}</strong></td>
                    </tr>
                    <tr>
    ...
    <div class="box" style="margin-top:10px;">
        <div class="box-title upper">Supplier / Attention</div>
        ...
        <tr>
            ...
            <td style="width:52%;vertical-align:top;">
                <table class="totals">
                    ...
                    <tr>
                        <td class="lab r">OUTSTANDING PAYABLE AFTER THIS ENTRY&nbsp;&nbsp;</td>
    ...
    <div class="terms muted">
        ...
        <ol type="1">
            ...
            <li>This memo relates to payables ledger activity recorded through BakiMate for {{ $shopName }}.</li>
        ...
        <div class="water muted">
            BakiMate · Printed {{ $issuedAt }} {{ config('app.timezone') }} · {{ $memoNo }}
        </div>
    </div>
</body>
</html>
