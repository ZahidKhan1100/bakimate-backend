...
<head>
    <meta charset="utf-8">
    <title>Payment to supplier — {{ $supplier->name }}</title>
    @include('pdf.partials.so-form-styles')
</head>
<body>
    @php /** @var \App\Models\Supplier $supplier */ @endphp
        ...
        <tr>
            ...
            <td style="width:42%;vertical-align:top;">
                <table class="meta-table" style="margin-top:0;">
                    ...
                    <tr>
                        <td class="meta-label r">VOUCHER NO.&nbsp;&nbsp;</td>
                        <td class="meta-val"><strong>{{ $voucherNo }}</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="meta-label r">SUPPLIER #&nbsp;&nbsp;</td>
                        <td class="meta-val">{{ $supplierRef }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div class="box" style="margin-top:10px;">
        <div class="box-title upper">Paid to</div>
        <strong>{{ strtoupper((string) $supplier->name) }}</strong><br>
        ADDRESS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: —
        @if($supplier->phone)
    ...
    <table class="totals-wrap">
        <tr>
            <td style="width:48%;vertical-align:top;padding-top:0;">
                <div class="words-box">
                    <div class="words-label upper">Ringgit Malaysia Amount Paid in Words:</div>
                    @if(($amountWords ?? '') !== '')
            ...
            <td style="width:52%;vertical-align:top;">
                <table class="totals">
                    <tr>
                        <td class="lab r">AMOUNT PAID&nbsp;&nbsp;</td>
                        <td class="r" style="width:38%;"><strong>{{ $totalDocumentFormatted }}</strong></td>
                    </tr>
                    <tr>
                        <td class="lab r">OUTSTANDING PAYABLE AFTER PAYMENT&nbsp;&nbsp;</td>
    ...
    <div class="terms muted">
        ...
        <ol type="1">
            <li>Payment reflected on the supplier (payables) ledger in {{ $currencyCode }}. Retain this voucher together with banking proof where applicable.</li>
            <li>Recorded through BakiMate for {{ $shopName }}.</li>
            <li>For discrepancies, contact the issuing shop with transaction reference {{ $voucherNo }}.</li>
        </ol>
        ...
        <div class="water muted">
            BakiMate · Printed {{ $issuedAt }} {{ config('app.timezone') }} · {{ $voucherNo }}
        </div>
    </div>
</body>
</html>
